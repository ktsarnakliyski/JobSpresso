    ...
    <div className="space-y-20">
      ...
      <section className="text-center pt-8 pb-4">
        <div className="animate-fade-up">
          <h1 className="text-4xl sm:text-5xl font-bold text-espresso-900 mb-5 tracking-tight text-balance">
            A Fresh Shot for Your{' '}
            <span className="gradient-text">Job Descriptions</span>
          </h1>
          <p className="text-lg text-espresso-600 max-w-2xl mx-auto mb-10 text-balance leading-relaxed">
      ...
      <section className="grid md:grid-cols-3 gap-6">
        <Card hover className="animate-fade-up [animation-delay:100ms] opacity-0">
          <div className="space-y-4">
            ...
            <h3 className="text-lg font-semibold text-espresso-900">Score & Analyze</h3>
        ...
        <Card hover className="animate-fade-up [animation-delay:200ms] opacity-0">
          <div className="space-y-4">
            ...
            <h3 className="text-lg font-semibold text-espresso-900">Smart Suggestions</h3>
            <p className="text-espresso-600 leading-relaxed">
        ...
        <Card hover className="animate-fade-up [animation-delay:300ms] opacity-0">
          <div className="space-y-4">
            ...
            <h3 className="text-lg font-semibold text-espresso-900">Voice Profiles</h3>
            <p className="text-espresso-600 leading-relaxed">
      ...
      <section className="space-y-10">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-espresso-900 mb-3">How It Works</h2>
          <p className="text-espresso-600">Three simple steps to better job descriptions</p>
        </div>
        <div className="grid md:grid-cols-3 gap-12">
          <div className="text-center animate-fade-up [animation-delay:100ms] opacity-0">
            <div className="w-12 h-12 bg-espresso-800 text-white rounded-2xl flex items-center justify-center mx-auto mb-5 font-bold text-lg shadow-soft-md">
              1
            </div>
            <h3 className="font-semibold text-espresso-900 mb-3">Paste or Create</h3>
            <p className="text-espresso-600 leading-relaxed">
          ...
          <div className="text-center animate-fade-up [animation-delay:200ms] opacity-0">
            ...
            <h3 className="font-semibold text-espresso-900 mb-3">Select a Voice</h3>
            <p className="text-espresso-600 leading-relaxed">
          ...
          <div className="text-center animate-fade-up [animation-delay:300ms] opacity-0">
            ...
            <h3 className="font-semibold text-espresso-900 mb-3">Get Results</h3>
            <p className="text-espresso-600 leading-relaxed">
      ...
      <section className="animate-fade-up [animation-delay:400ms] opacity-0">
        <Card padding="lg" className="text-center bg-gradient-to-br from-espresso-50 to-white">
          <h2 className="text-2xl font-bold text-espresso-900 mb-3">Ready to get started?</h2>
          <p className="text-espresso-600 mb-6 max-w-md mx-auto">
